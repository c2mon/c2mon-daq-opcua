...
public class MethodIT {
    ...
    @BeforeAll
    public static void setUpEndpoint() throws ConfigurationException {
    ...
    @Test
    public void executeMethodWithoutParentReturnsProperResult() throws ConfigurationException {
    ...
    @Test
    public void executeMethodWithParentReturnsProperResult() throws ConfigurationException {

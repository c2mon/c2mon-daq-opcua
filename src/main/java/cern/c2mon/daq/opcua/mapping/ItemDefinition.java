 ...
 * {@link ISourceCommandTag} including the {@link NodeId} and Deadband values. Every {@link ItemDefinition} is
...
public class ItemDefinition {
    ...
    /**
     * This equals the redundant item name of a {@link OPCHardwareAddress}. If this value is set in an
     * {@link ISourceDataTag}, it is subscribed to equally with the primary nodeId. If it is set on an
     * {@link ISourceCommandTag} of type
     * {@link cern.c2mon.shared.common.datatag.address.OPCCommandHardwareAddress.COMMAND_TYPE} METHOD, the primary
     * {@link NodeId} is interpreted as referring to the containing object Node, and the methodNodeId as referring to
     * the method Node.
     */
    ...
    private ItemDefinition(NodeId nodeId, NodeId methodNodeId, int timeDeadband, float valueDeadband,
            int valueDeadbandType) {
        this.nodeId = nodeId;
    ...
    /**
     * Stores the relevant information contained in an {@link ISourceDataTag} into a corresponding
     * {@link ItemDefinition} including the {@link NodeId}s and Deadband values.
     * 
    ...
    /**
     * Stores the relevant information contained in an {@link ISourceCommandTag} into a corresponding
     * {@link ItemDefinition} including primary and method {@link NodeId}s.
     * 

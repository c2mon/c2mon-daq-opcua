...
public abstract class OPCUAException extends EqIOException {
     ...
     */
    public static final ImmutableSet<Long> TERMINAL = ImmutableSet.<Long>builder().add(Bad_InternalError, Bad_OutOfMemory, Bad_Shutdown, Bad_ServerHalted, Bad_NonceInvalid, Bad_TooManySessions, Bad_TcpInternalError, Bad_DeviceFailure, Bad_SensorFailure, Bad_OutOfService).build();

    /**
     * Status Codes representing states that could be solved by disconnecting and reconnecting
     */
    public static final ImmutableSet<Long> RECONNECT = ImmutableSet.<Long>builder().add(Bad_ServerNotConnected, Bad_SessionIdInvalid, Bad_SessionClosed, Bad_SessionNotActivated, Bad_NoCommunication, Bad_NotConnected, Bad_Disconnect).build();

    /**
     * Status Codes representing states where retrying an operation again may work
     */
    public static final ImmutableSet<Long> RETRY_LATER = ImmutableSet.<Long>builder().add(Bad_ResourceUnavailable, Uncertain_NoCommunicationLastUsableValue, Uncertain_SensorNotAccurate, Bad_TooManyPublishRequests).build();

    /**
     * Status Codes returned by the server hinting at misconfigurations.
     */
    public static final ImmutableSet<Long> CONFIG = ImmutableSet.<Long>builder().add(Bad_NodeIdUnknown, Bad_ServerUriInvalid, Bad_FilterNotAllowed, Bad_ServerNameMissing, Bad_DiscoveryUrlMissing, Bad_DeadbandFilterInvalid, Bad_ConfigurationError, Bad_TcpEndpointUrlInvalid, Bad_MethodInvalid, Bad_ArgumentsMissing, Bad_WriteNotSupported, Bad_HistoryOperationUnsupported, Bad_HistoryOperationInvalid, Bad_NoDeleteRights, Bad_TargetNodeIdInvalid, Bad_SourceNodeIdInvalid, Bad_NodeIdRejected, Bad_FilterOperandInvalid).build();


    /**
     * Status Codes returned by the server hinting at misconfigurations.
     */
    public static final ImmutableSet<Long> SECURITY_CONFIG = ImmutableSet.<Long>builder().add(Bad_UserSignatureInvalid, Bad_UserAccessDenied, Bad_CertificateHostNameInvalid, Bad_ApplicationSignatureInvalid, Bad_CertificateIssuerUseNotAllowed, Bad_CertificateIssuerTimeInvalid, Bad_CertificateIssuerRevoked).build();
    ...
    public static OPCUAException rethrow(ExceptionContext context, Throwable e, boolean retriesExceeded) {
    ...
    public static boolean isConfigIssue(UaException e) {

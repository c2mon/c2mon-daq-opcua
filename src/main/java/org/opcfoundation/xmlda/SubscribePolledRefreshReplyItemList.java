 ...
 */
            ...
            /**
            *  SubscribePolledRefreshReplyItemList bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected org.opcfoundation.xmlda.ItemValue[] localItems ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return org.opcfoundation.webservices.xmlda._1_0.ItemValue[]
                           */
                           public  org.opcfoundation.xmlda.ItemValue[] getItems(){
                               return localItems;
                           }
                               ...
                               */
                              protected void validateItems(org.opcfoundation.xmlda.ItemValue[] param){
                              ...
                              * @param param Items
                              */
                              public void setItems(org.opcfoundation.xmlda.ItemValue[] param){
                             ...
                             * @param param org.opcfoundation.webservices.xmlda._1_0.ItemValue
                             */
                             public void addItems(org.opcfoundation.xmlda.ItemValue param){
                                   if (localItems == null){
                                   localItems = new org.opcfoundation.xmlda.ItemValue[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localItems);
                               list.add(param);
                               this.localItems =
                             (org.opcfoundation.xmlda.ItemValue[])list.toArray(
                            new org.opcfoundation.xmlda.ItemValue[list.size()]);
                        ...
                        */
                                    ...
                                    protected java.lang.String localSubscriptionHandle ;
                           ...
                           */
                           public  java.lang.String getSubscriptionHandle(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param SubscriptionHandle
                               */
                               public void setSubscriptionHandle(java.lang.String param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SubscribePolledRefreshReplyItemList",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                            ...
                                            if (localSubscriptionHandle != null){
                                        
                                                writeAttribute("",
                                                         "SubscriptionHandle",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSubscriptionHandle), xmlWriter);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localItemsTracker){
                            ...
                            attribList.add(
                            new javax.xml.namespace.QName("","SubscriptionHandle"));
                            
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSubscriptionHandle));
        ...
        public static SubscribePolledRefreshReplyItemList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SubscribePolledRefreshReplyItemList".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SubscribePolledRefreshReplyItemList)org.opcfoundation.xmlda.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    java.lang.String tempAttribSubscriptionHandle =
                        
                                reader.getAttributeValue(null,"SubscriptionHandle");
                            
                   if (tempAttribSubscriptionHandle!=null){
                         java.lang.String content = tempAttribSubscriptionHandle;
                    ...
                    handledAttributes.add("SubscriptionHandle");
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(org.opcfoundation.xmlda.ItemValue.Factory.parse(reader));
                                                        ...
                                                        object.setItems((org.opcfoundation.xmlda.ItemValue[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                org.opcfoundation.xmlda.ItemValue.class,
                                                                list1));

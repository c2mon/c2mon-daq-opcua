        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected org.opcfoundation.xmlda.ItemValue localItemValue ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           public boolean isItemValueSpecified(){
                               return localItemValueTracker;
                           }
                           ...
                           */
                           public  org.opcfoundation.xmlda.ItemValue getItemValue(){
                            ...
                            /**
                               ...
                               */
                               public void setItemValue(org.opcfoundation.xmlda.ItemValue param){
                            localItemValueTracker = param != null;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SubscribeItemValue",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SubscribeItemValue",
                           xmlWriter);
                                     ...
                                     if (localItemValueTracker){
                                            if (localItemValue==null){
                                                 throw new org.apache.axis2.databinding.ADBException("ItemValue cannot be null!!");
                                            }
                                           localItemValue.serialize(new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/","ItemValue"),
                                               xmlWriter);
                                        }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localItemValueTracker){
                            elementList.add(new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/",
                                    ...
                                    elementList.add(localItemValue);
                                }
                            attribList.add(
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SubscribeItemValue".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SubscribeItemValue)org.opcfoundation.xmlda.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                   ...
                   if (tempAttribRevisedSamplingRate!=null){
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/","ItemValue").equals(reader.getName())){
                                                ...
                                                object.setItemValue(org.opcfoundation.xmlda.ItemValue.Factory.parse(reader));

...
public class AddressStringParserTest {
    ...
    @Test
    public void redundantAddress() throws URISyntaxException {
    ...
    public void createInvalidUriShouldThrowException() {
        ...
        assertThrows(AddressException.class, () -> addressFromNewParser(addressString));
    }
    ...
    private EquipmentAddress addressFromNewParser(String addressString) {

...
public class ItemDefintionTest {
    ...
    public void testEquals() {
        ItemDefinition<String> address1 = new ItemDefinition<>(1L, "asd");
        ItemDefinition<String> address2 = new ItemDefinition<>(1L, "asd2");
        ItemDefinition<String> address3 = new ItemDefinition<>(2L, "asd");
